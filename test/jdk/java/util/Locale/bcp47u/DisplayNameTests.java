 ...
 *
 * @test
 * @bug 8176841 8202537 8354548 8384532
...
public class DisplayNameTests {
    ...
    static Object[][] locales() {
        return new Object[][] {
            ...
            {Locale.JAPAN, loc1,
            "英語 (ラテン文字、アメリカ合衆国、和暦、会計通貨フォーマット、ピンイン順、通貨: 日本円、絵文字表示方法: emoji、週の開始曜日: wed、24時間制(0〜23)、禁則処理(弱)、単語途中の改行: breakall、ヤード・ポンド法、ローマ数字、補足データ用地域: イギリス、地域区画: gbsct、略語の後の文分割: standard、タイムゾーン: 日本時間、ロケールのバリアント: posix)"},
            {Locale.forLanguageTag("hi-IN"), loc1,
            "अंग्रेज़ी (लैटिन, संयुक्त राज्य, जापानी पंचांग, लेखांकन मुद्रा प्रारूप, पिनयिन वर्गीकरण क्रम, मुद्रा: जापानी येन, इमोजी का प्रज़ेंटेशन: emoji, सप्ताह का पहला दिन: wed, 24 घंटों की प्रणाली (0–23), ढीली पंक्ति विच्छेद शैली, शब्दों के बीच पंक्ति विच्छेद: breakall, इम्पीरियल मापन प्रणाली, रोमन संख्याएँ, अनुपूरक डेटा के लिए क्षेत्र: यूनाइटेड किंगडम, उपखंड क्षेत्र: gbsct, संक्षेपण के बाद वाक्य विच्छेद: standard, समय क्षेत्र: जापान समय, स्थानीय प्रकार: posix)"},
            ...
            {loc6, loc6, "中文 (中国，日历：dddd，货币：ddd，一周起始日：moq，数字：ddd，补充数据的区域：twzz，时区：unknown)"},
